...
of words, either related somehow (meronymy, hyponymy, hiponymy, antonymy, etc.), or unrelated.
Next, a group of individual experts are given the task to estimate relatedness of those pairs.
Estimations may be four distinct grades, or fraction from 0.0 to 1.0. Typical group size is 
about 10-15 people.
...
has been developing for decades, starting with Latent Semantic Analysis (Landauer, 1998), 
Latent Semantic Indexing, finally Explicit Semantic Analysis (Gabrilovich, 2007), and numerous
Wordnet and Wikipedia-based works (Zesch, 2008).
...
by (Mikolov et al., 2013), with use of simplified neural network models, Continious Bag-of-Words
...
The area is "hot ground", there are works such as elections prediction (Metaxas, 2011), sentiment
analysis and so on.
...
subset, and cross-checking it with well-known linguistic resource of Russian literature.


\section{Algorythm and input data}
